...
def test_scale_pairs():
    ...
    assert sh("cp ../epicode/data/test_ab_cnt.arr test_scale_pairs") == 0
...
def test_scale_diff():
    ...
    assert sh("cp ../epicode/data/test_ab_cnt_deseq.arr test_scale_diff") == 0
...
def test_scale_features():
    ...
    assert sh("cp ../epicode/data/test_ab_cnt_deseq_lvl.arr test_scale_features") == 0
...
def test_code_sklearn():
    ...
    assert sh("cp ../epicode/data/a549_start_lvl_sig95.arr test_code_sklearn") == 0
...
def test_multi_code_sklearn():
    ...
    assert sh("cp ../epicode/data/{0,1}*sig95.arr test_multicode_sklearn") == 0
...
def test_recode_sklearn():
    ...
    assert sh("cp ../epicode/data/0*sig95.arr test_recode_sklearn") == 0
    assert sh("cp ../epicode/data/tss_vs_enh_pgnmf-c#6-i#None-p#.epi test_recode_sklearn") == 0
